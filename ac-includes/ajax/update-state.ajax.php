...
$update="UPDATE ".$table." SET ".$field."='".mysqli_real_escape_string($db_cal,$new_state)."' WHERE id=".mysqli_real_escape_string($db_cal,$id_item)." LIMIT 1";
mysqli_query($db_cal,$update) or die("Error updating state");
echo $new_state;
?>